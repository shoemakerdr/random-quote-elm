...
var _user$project$Main$randomQuote = function (quotes) {
	return _elm_community$random_extra$Random_List$choose(quotes);
};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {current: a, all: b, errorMessage: c};
	});
var _user$project$Main$Quote = F2(
	function (a, b) {
		return {quote: a, name: b};
	});
var _user$project$Main$franklin = A2(_user$project$Main$Quote, 'The only thing to fear is fear itself.', 'Franklin D Roosevelt');
var _user$project$Main$quoteDecoder = A3(
	...
	A3(
		...
		'quote',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Quote)));
var _user$project$Main$quoteListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$quoteDecoder);
			...
			case 'GetRandomQuote':
				return {
					...
					_1: A2(
						...
						_user$project$Main$randomQuote(model.all))
				};
			default:
				var _p1 = _p0._0._0;
				if (_p1.ctor === 'Just') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{current: _user$project$Main$franklin}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
		}
	});
var _user$project$Main$GetRandomQuote = {ctor: 'GetRandomQuote'};
var _user$project$Main$view = function (model) {
	var errorMessage = model.errorMessage;
	var name = model.current.name;
	var quote = model.current.quote;
	var twitterUrl = A2(
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Elm Random Quote Generator'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('quote-wrapper'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('button-wrapper'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href(twitterUrl),
									_1: {
										ctor: '::',
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Tweet This Quote'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$GetRandomQuote),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$Main$FetchQuotes = function (a) {
	return {ctor: 'FetchQuotes', _0: a};
};
var _user$project$Main$getQuotes = function () {
	var url = 'https://raw.githubusercontent.com/shoemakerdr/RandomQuoteProject/master/quotes.json';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$FetchQuotes,
		A2(_elm_lang$http$Http$get, url, _user$project$Main$quoteListDecoder));
}();
var _user$project$Main$init = F3(
	function (current, list, err) {
		return {
			ctor: '_Tuple2',
			_0: A3(_user$project$Main$Model, current, list, err),
			_1: _user$project$Main$getQuotes
		};
	});
